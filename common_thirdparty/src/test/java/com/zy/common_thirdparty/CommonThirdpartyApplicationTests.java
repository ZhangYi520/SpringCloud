...
@SpringBootTest
public class CommonThirdpartyApplicationTests {
    ...
    public void sendSimpleMail() throws MessagingException {
        ...
        mailService.sendSimpleMail("1073988580@qq.com","我是一封邮件",content);
    }
    ...
    public void sendHtmlMail() throws MessagingException {
        ...
        String content="<html>\n"+
                ...
                "</body>\n"+
                "</html>";
        mailService.sendHtmlMail("1073988580@qq.com","我是一封邮件",content);
    }
