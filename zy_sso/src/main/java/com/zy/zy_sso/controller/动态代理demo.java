 ...
 * @description: 动态代理
 * @author: zhang yi
 * @create: 2019-10-24 10:37
 */
public class 动态代理demo {
    public static void main(String[] args) {
        DynamicProxyUtil proxy = new DynamicProxyUtil(new UserManagerImpl());
        //获得代理对象
        UserManager p =(UserManager) proxy.Instance();
        //调用代理对象的sing方法
        p.addUser();
    }
 ...
 */
class DynamicProxyUtil implements InvocationHandler {
